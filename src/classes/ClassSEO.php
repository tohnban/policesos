...
{
    // Site configuration
    const SITE_NAME = 'Imobil Fácil';
    const SITE_DESCRIPTION = 'Encontre, anuncie e negocie imóveis de forma simples e segura';
    const SITE_DOMAIN = '';  // Will use DIRPAGE from config
